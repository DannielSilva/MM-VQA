# Feedback Transformer implementation from
# https://github.com/lucidrains/feedback-transformer-pytorch

# The core of this file is from the repo, just some
# minor edits to be able to couple with MMBERT
...
class FeedbackTransformer(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.to_logits_bool = to_logits_bool
